...
function initialiseGraph(){
	...
	label=r.image("assets/img/we-are-here.png",0,0,71,20);
	...
	logos=r.image("assets/img/logos.png",config.offset.x+config.dimension.width-175,config.offset.y+config.dimension.height-70,155,55);
	updateGraph()
}
